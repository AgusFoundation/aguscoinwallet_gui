...
const char COMMUNITY_FORUM_URL[] = "https://aguscoin.com";
const char REPORT_ISSUE_URL[] = "https://aguscoin.com";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Aguscoin Wallet %1").arg(Settings::instance().getVersion()));
