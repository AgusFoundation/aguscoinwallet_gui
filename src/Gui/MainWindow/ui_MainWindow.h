...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/aguscoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutAguscoinAction = new QAction(MainWindow);
        m_aboutAguscoinAction->setObjectName(QStringLiteral("m_aboutAguscoinAction"));
        m_aboutAguscoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutAguscoinAction);
        ...
        QObject::connect(m_aboutAguscoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutAguscoinAction->setText(QApplication::translate("MainWindow", "About Aguscoin", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND AGUSCOINS", 0));
